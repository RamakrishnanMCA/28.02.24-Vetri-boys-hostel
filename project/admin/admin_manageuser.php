...
<body>
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="#"><i class="fas fa-envelope"></i>Add Rooms</a></li>
        ...
        <table>
            ...
            if($result-> num_rows>0){
                while($row=$result->fetch_assoc()){
                    ...
                    .$row["address"]."</td><td>".$row["phone_number"]."</td><td>".$row["email"]."</td><td>".$row["password"]."</td><td><a href='edit-user.php?id=".$row["id"]."'>Edit</a></td>
                    <td><a href='delete-user.php?id=".$row["id"]."'>Remove</a></td></tr>";
                }
                echo"</table>";
            }
            else{
